...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-80099580fc3c4044a768.js"
  },
  {
  ...
  {
    "url": "app-bd0223ef4228bb636dcc.js"
  },
  {
    "url": "offline-plugin-app-shell-fallback/index.html",
    "revision": "faf118effe04d68899ee7e9e9c8133b2"
  },
  {
  ...
  },
  {
    ...
    "revision": "a36dbe98a98c11333c623920d57563a8"
  },
  {
  ...
  },
  {
    ...
    "revision": "87604e15e917e01df41040f12081fc6a"
  },
  {
  ...
  },
  {
    ...
    "revision": "de09c5fc4b8446c9050350ea05320118"
  },
  {
  ...
  },
  {
    ...
    "revision": "95894bbe60d31ae3d56018d3f325e992"
  }
...
const navigationRoute = new NavigationRoute(async ({ event }) => {
  ...
  pathname = pathname.replace(new RegExp(`^/ifrs`), ``)

  // Check for resources + the app bundle
  // The latter may not exist if the SW is updating to a new version
  const resources = await idbKeyval.get(`resources:${pathname}`)
  if (!resources || !(await caches.match(`/ifrs/app-bd0223ef4228bb636dcc.js`))) {
    return await fetch(event.request)
  }
  ...
  const offlineShell = `/ifrs/offline-plugin-app-shell-fallback/index.html`
